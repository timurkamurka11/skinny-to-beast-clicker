...
ТЗ не утверждает внутреннюю технологию Lamar. Публичная игра используется только как референс уровня живости и ритма idle-персонажа; весь арт, риг и анимации должны быть оригинальными.
